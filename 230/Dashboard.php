...
$query ="SELECT id,title,due FROM Solicitation where status='Published'";
...
<div class="topnav">
	...
	<a class="pull-right" href="Status.php?id=<?php echo $_SESSION['login_id'];?>">Check Status</a>
	<?php }else{ ?>
	<a class="pull-right" href="register.php">Register</a>
	<?php } ?>
	<a class="pull-right" href="Messages.php?id=<?php echo $_SESSION['login_id'];?>">Messages</a>
...
<div class="container">
    ...
    <div class="table-responsive">
        <table id="employee_data" class="table table-striped table-bordered">
            ...
            { ?>
                <tr>  
				<td><a href="http://localhost:8888/codeigniter/index.php/welcome/check2?id=<?php echo $row["id"]; ?>" class="solicitate" style="cursor:pointer;"><?php echo $row["id"];?></a></td>
