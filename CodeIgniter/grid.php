...
?>
                        ...
                        <?php elseif($post->status=="Under Review"):?>
                            <td style="font-size: 17px; font-weight: 490;" class="text-primary "> <?php echo $post->status;?></td>
                        <?php elseif($post->status=="Approved"):?>
                            <td style="font-size: 17px; font-weight: 490;" class="text-success"> <?php echo $post->status;?></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="" type="button" class="btn btn-default" data-dismiss="modal">Publish</a>
