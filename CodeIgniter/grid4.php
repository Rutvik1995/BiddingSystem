    ...
    <div class="table-responsive">
        <table id="employee_data" class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td style="font-size: 110%;">Review</td>
...
<a  href="http://localhost:8888/codeigniter/index.php/welcome/checkingpage2?id='.$post->id.'"   style="background-color:#1898DD; color:white;" class="btn  btn-xs"  ><span style="width: 40px;" class="glyphicon glyphicon-folder-close"></span></a></p>
