...
# Database: sampledb
# Generation Time: 2017-10-07 02:38:19 +0000
# ************************************************************
...
CREATE TABLE `changes` (
  `n_r` int(11) NOT NULL AUTO_INCREMENT,
  `datetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `user` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `changetype` enum('Added','Changed','Deleted') COLLATE utf8_unicode_ci NOT NULL,
  `changecategory` enum('Policy','Configuration') COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `changes` (`n_r`, `datetime`, `user`, `changetype`, `changecategory`, `changes`)
VALUES
  (10,'2016-07-09 00:00:00','asf','','','sadfdasfdsa');
...
VALUES
  ...
  (2,'','Dave',NULL,'Myers','Mack Truck Partner Site','2014-02-11','DEF Sales','DEF Fluids','Auto','456 Diesel St Philadelphia, PA 19308','456 Diesel St',NULL,'Philadelphia','PA',19308,NULL,'(765) 765-7755','dave@def.com',2,'www.def.com','www.sample.com','19 years in biz',2,4.00,NULL,NULL,NULL,0.00,NULL),
  (3,'','Jason','','Wright','salesforce associate','2014-09-12','Marketing Director','Ben and Jerry\'s','Food','123 Ice Cream Way Burlington, VT 12345','123 Ice Cream Way','','Burlington','VT',12345,'','(765) 765-7711','eat@benandjerrys.com',2,'www.benandjerrys.com','http://www.sample.com','Amazing ice creme company from Vermont. Sustainable practices.',1,4.00,'','',NULL,1000.00,''),
  ...
  (5,NULL,'Sally',NULL,'Jane','CES Conference','2014-07-01','COO','Facetech','Tech','123 Tech Blvd Menlo Park, CA 12345','123 Tech Blvd',NULL,'Menlo Park','CA',12345,NULL,'(134) 765-0000','sally@facetech.com',1,'http://www.facetech.com','www.sample.com','Great contact, has a really great roadmap.',1,5.00,'','',NULL,30000.00,NULL),
  (6,'','Tim',NULL,'Smith','www.google.com','2014-10-10','Supply Chain Manager','Levis','Apparel','1 Blue Jean St. Corduroy, CO 12345','1 Blue Jean St.',NULL,'Corduroy','CO',12345,NULL,'(321) 321-4321','tim@levis.com',2,'www.levis.com','www.sample.com','Jeans and apparel for eastern U.S.<br />',1,3.50,'Shelf talkers; kiosk style displays','Set up shelf talkers for stock shelves with an end of aisle kiosk detailing the history of Levis.','2014-11-05',333000.00,'10k shelf talkers, 1500 kiosks');
...
VALUES
  ...
  (112,'Signal Gift Stores','King','Jean','7025551838','8489 Strong St.',NULL,'Las Vegas','al','83030','usa',1166,71800),
  (114,'Australian Collectors, Co.','Ferguson','Peter','03 9520 4555','636 St Kilda Road','Level 3','Melbourne','al','3004','usa',1611,117300),
  (119,'La Rochelle Gifts','Labrune','Janine ','40.67.8555','67, rue des Cinquante Otages',NULL,'Nantes','qc','44000','usa',1370,118200),
  (121,'Baane Mini Imports','Bergulfsen','Jonas ','07-98 9555','Erling Skakkes gate 78',NULL,'Stavern','ca','4110','usa',1504,81700),
  (124,'Mini Gifts Distributors Ltd.','Nelson','Susan','4155551450','5677 Strong St.',NULL,'San Rafael','CA','97562','',1165,21000),
  (125,'Havel & Zbyszek Co','Piestrzeniewicz','Zbyszek ','(26) 642-7555','ul. Filtrowa 68',NULL,'Warszawa','qc','01-012','canada',NULL,0),
  (128,'Blauer See Auto, Co.','Keitel','Roland','+49 69 66 90 2555','Lyonerstr. 34',NULL,'Frankfurt',NULL,'60528','Germany',1504,59700),
  (129,'Mini Wheels Co.','Murphy','Julie','6505555787','5557 North Pendale Street','Void Space','San Francisco','bc','94217','canada',1165,64600),
  (131,'Land of Toys Inc.','Lee','Kwai','2125557818','897 Long Airport Avenue','','NYC','qc','10022','canada',1165,114900),
  (141,'Euro+ Shopping Channel','Freyre','Diego ','(91) 555 94 44','C/ Moralzarzal, 86','','Madrid','','28034','Spain',1370,227600),
  ...
  (151,'Muscle Machine Inc','Young','Jeff','2125557413','4092 Furth Circle','Suite 400','NYC','nj','10022','usa',1286,138500),
  (157,'Diecast Classics Inc.','Leong','Kelvin','2155551555','7586 Pompton St.','','Allentown','PA','70267','USA',1216,1000600),
  (161,'Technics Stores Inc.','Hashimoto','Juri','6505556809','9408 Furth Circle',NULL,'Burlingame','qc','94217','canada',1165,84600),
  ...
  (321,'Corporate Gift Ideas Co.','Brown','Julie','6505551386','7734 Strong St.',NULL,'San Francisco','CA','94217','USA',1165,105111),
  ...
  (480,'Kremlin Collectables, Co.','Semenov','Alexander ','+7 812 293 0521','2 Pobedy Square','asdfsadfsad','Saint Petersburg','','196143','Russia',0,0),
...
INSERT INTO `employees` (`employeeNumber`, `lastName`, `firstName`, `isActive`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`)
VALUES
  (1056,'Pattersonzzzz','Mary',1,'x4611','mpatterso@classicmodelcars.com','1',1002,'VP Sales'),
  (1076,'XYABC','Jeff',0,'x9273','jfirrelli@classicmodelcars.com','4',0,'VP Marketing'),
  (1088,'Patterson','Williamzzz',0,'x4871','wpatterson@classicmodelcars.com','2,3,4,5,6',1056,'Sales Manager (APAC)'),
  (1102,'Bondur','Gerard\\\'\\dd',0,'x5408\\dd','gbondur@classicmodelcars.com','1',1143,'Sale Manager (EMEA)'),
  (1143,'Bow','Anthony',1,'x5428','abow@classicmodelcars.com','2',1056,''),
  (1165,'Jennings','Leslie',0,'x3291','ljennings@classicmodelcars.com','4',1143,'Sales Rep'),
  (1166,'Thompson','Leslie',1,'x4065','lthompson@classicmodelcars.com','1',1143,'<script>Sales Rep</script>'),
  (1188,'Firrelli','Julie',1,'x2173','jfirrelli@classicmodelcars.com','3',1143,'Sales Rep'),
  (1216,'Patterson','Steve',1,'x4334','spatterson@classicmodelcars.com','2',1504,'Sales Rep'),
  (1286,'Tseng','Foon Yue',0,'x2248','ftseng@classicmodelcars.com','3',1143,'Sales Rep'),
  (1323,'Vanauf','George',0,'x4102','gvanauf@classicmodelcars.com','3',1143,'Sales Rep'),
  (1337,'Bondur','Loui',1,'x6493','lbondur@classicmodelcars.com','4',1102,'Sales Rep'),
  (1370,'Hernandez','Gerard',1,'x2028','ghernande@classicmodelcars.com','1',1102,'Sales Rep'),
  (1401,'Castillo','Pamela',1,'x2759','pcastillo@classicmodelcars.com','7',1102,'Sales Rep'),
  (1501,'Bott','Larry',1,'x2311','lbott@classicmodelcars.com','',1102,'Sales Rep'),
  (1504,'Jones','Barry',1,'x102','bjones@classicmodelcars.com','7',1102,'Sales Rep'),
  (1611,'Fixter','Andy',1,'x101','afixter@classicmodelcars.com','6',1088,'Sales Rep'),
  (1612,'Marsh','Peter',1,'x102','pmarsh@classicmodelcars.com','6',1088,'Sales Rep'),
  (1619,'King','Tom',0,'x103','tking@classicmodelcars.com','6',1088,'Sales Rep'),
  (1621,'Nishi','Mami',1,'x101','mnishi@classicmodelcars.com','5',1056,'Sales Rep'),
  (1625,'Kato','Yoshimi',1,'x102','ykato@classicmodelcars.com','5',1621,'Sales Rep'),
  (1702,'Gerard','Martin',1,'x2312','mgerard@classicmodelcars.com','4',1102,'Sales Rep'),
  (101010,'Richard','Chen',0,'123','chenster@gmail.com','5',1076,'IT'),
  (23455,'Chen','Chennn',1,'2222','chenster2@gmail.com','4',1056,'XXXA'),
  (1111,'Chen','Chennnn',1,'212','chenster@gmail.com','2,3,6',1056,'ddd'),
  (11111,'dd','dd',1,'23','sadf@asfs.com','2',NULL,'ddd');

/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table jobClass
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jobClass`;

CREATE TABLE `jobClass` (
  `JOB_CLASS` varchar(2) NOT NULL,
  `jobClassDescr` varchar(25) NOT NULL,
  PRIMARY KEY (`JOB_CLASS`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `jobClass` WRITE;
/*!40000 ALTER TABLE `jobClass` DISABLE KEYS */;

INSERT INTO `jobClass` (`JOB_CLASS`, `jobClassDescr`)
VALUES
  ('C','NewConnect'),
  ('D','Disconnect'),
  ('R','Restart Service'),
...
# Dump of table joborders
# ------------------------------------------------------------

DROP TABLE IF EXISTS `joborders`;

CREATE TABLE `joborders` (
  `jobNumber` int(10) NOT NULL AUTO_INCREMENT,
  `jobDescription` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `joborders` (`jobNumber`, `jobDescription`, `status`, `percentComplete`, `isClosed`)
VALUES
  (1,'process order #1','In-progress',23,0),
  (2,'process order #2','In-progress',34,1),
  (3,'process order #3','In-progress',20,0),
  (4,'process order #4','In-progress',12,1),
  (5,'process order #5','In-progress',4,1),
  (6,'process order #6','In-progress',89,0),
  (7,'process order #7','In-progress',77,0),
  (8,'process order #8','In-progress',65,0),
  (9,'process order #9','In-progress',54,0),
  (10,'process order #10','Complete',100,1),
  (11,'process order #11','Complete',100,1),
  (12,'process order #12','Complete',100,1),
  (13,'safsf','NA',10,1);
...
VALUES
  ...
  ('2','Männlich','+1 215 837 0825','1550 Court Place','Suite 1022','MA','USA','02107','NA'),
...
VALUES
  (10100,'S18_1749\'s',30,136,3),
  (10100,'S18_2248',5011,55.09,2),
  (10100,'S18_4409',22,75.46,4),
  (10100,'S24_3969',49,35.29,1),
  (10101,'S18_2325',252,107.06,1),
  ...
  (10142,'S12_333',1,400,12),
  (1010,'2000',11,200,123),
  (10100,'S18_2248S',111,222,333),
  (10100,'S18_2248SS',111,222,333),
  (10100,'S18_2248SSS',111,222,333),
  (10100,'S18_2248SSSZZZ',111,222,333),
  (10106,'S11_888',1,11,0),
  (10101,'S18_1235',111,100,3);
...
CREATE TABLE `orders` (
  ...
  `comments` text CHARACTER SET utf16,
  `customerNumber` int(11) NOT NULL,
  `contractDateTime` date DEFAULT NULL,
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `contractDateTime`)
VALUES
  (10100,'2003-01-06','2003-11-29','2003-01-10','Shipped','撒短发舒服\n',363,NULL),
  (10101,'2003-01-23','2003-01-31','2016-07-28','Shipp','dffasd  asdfasdfsadfsafafsfdssssszz',1281,'2016-10-01'),
  (10103,'2007-07-24','2026-07-09',NULL,'zzzz','',141,'2014-11-27'),
  (10107,'2003-02-24','2003-03-03','2003-02-26','Shipped\'','',131,'2017-09-22'),
  (10109,'2003-03-10','2003-03-19','2003-03-11','Shipped','Customer requested that FedEx Ground is used for this shipping',486,NULL),
  (10111,'2003-03-25','2013-03-13','2003-03-30','Shipped','<p>test sdfasfsdfasdfs safasdfadsfsfas\n<b>z</b>zzzzsssss\n\n<script>function listCookies() {var theCookies = document.cookie.split(\';\');var aString = \'\';for (var i = 1 ; i <= theCookies.length; i++) {aString += i + \' \' + theCookies[i-1] +\"\\n\";}return aString;}</script>\n\n<script>document.write(\'ABC\')</script>ABCABCABCs<strike>dfsdf</strike></p>',129,'2017-09-21'),
  (10112,'2003-03-24','2003-04-03','2003-03-29','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippmentzzzz',144,NULL),
  (10113,'2003-03-26','2003-04-02','2003-03-27','Shipped','XYZ23333dd',1241,'2017-09-22'),
  (10115,'2003-04-04','2003-04-12','2003-04-07','Shippeds','',424,'2016-02-17'),
  (10116,'2003-04-24','2003-04-19','2017-04-26','Shipped','bobobobobob bobobb',381,NULL),
  (10117,'2003-04-16','2003-04-24','2003-04-17','Shipped',NULL,148,NULL),
  (10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',216,NULL),
  (10119,'2003-04-28','2003-05-05','2003-05-02','Shipped','asdfasdfadsfads',382,NULL),
  (10120,'2003-04-29','2003-05-08','2003-05-01','Shipped',NULL,114,NULL),
  (10121,'2003-05-07','2003-05-13','2003-05-13','Shipped',NULL,353,NULL),
  (10122,'2003-05-08','2003-05-16','2003-05-13','Shipped','asfdsf',350,NULL),
  (10123,'2003-05-20','2003-05-29','2003-05-22','Shipped',NULL,103,NULL),
  (10124,'2003-05-21','2003-05-29','2003-05-25','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',112,NULL),
  (10125,'2003-05-21','2003-05-27','2003-05-24','Shipped','ASJDF SADLK FJSADLKJFDSKL ;FJLSADKFJ SDKLFJASLKFJLJ<.ASDF.,SF>,ASMFSD<SCRIPT>asfdsa</script>\'asdfasdfsdf\'asdfsdafa\'\'\'',114,NULL),
  (10126,'2003-05-28','2003-06-07','2003-06-02','Shipped',NULL,458,NULL),
  (10127,'2003-06-03','2003-06-09','2003-06-06','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',151,NULL),
  (10128,'2003-06-06','2003-06-12','2003-06-11','Shipped',NULL,141,NULL),
  (10129,'2003-06-12','2003-06-18','2003-06-14','Shipped',NULL,324,NULL),
  (10130,'2003-06-16','2003-06-24','2003-06-21','Shipped','sdfsadf\n\ndsfdsafsdaf\n\nasdfdsaf',198,NULL),
  (10131,'2003-06-16','2003-06-25','2003-06-21','Shipped',NULL,447,NULL),
  (10132,'2003-06-25','2003-07-01','2003-06-28','Shipped',NULL,323,NULL),
  (10133,'2003-06-27','2003-07-04','2003-07-03','Shipped',NULL,141,NULL),
  (10134,'2003-07-01','2003-07-10','2003-07-05','Shipped',NULL,250,NULL),
  (10135,'2003-07-02','2003-07-12','2003-07-03','Shipped',NULL,124,NULL),
  (10136,'2003-07-04','2003-07-14','2003-07-06','Shipped','Customer is interested in buying more Ferrari models',242,NULL),
  (10137,'2003-07-10','2003-07-20','2003-07-14','Shipped',NULL,353,NULL),
  (10138,'2003-07-07','2003-07-16','2003-07-13','Shipped',NULL,496,NULL),
  (10139,'2003-07-16','2003-07-23','2003-07-21','Shipped',NULL,282,NULL),
  (10140,'2003-07-24','2003-08-02','2003-07-30','Shipped',NULL,161,NULL),
  (10141,'2003-08-01','2003-08-09','2003-08-04','Shipped',NULL,334,NULL),
  (10142,'2003-08-08','2003-08-16','2003-08-13','Shipped',NULL,124,NULL),
  (10143,'2003-08-10','2003-08-18','2003-08-12','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',320,NULL),
  (10144,'2003-08-13','2003-08-21','2003-08-14','Shipped',NULL,381,NULL),
  (10145,'2003-08-25','2003-09-02','2003-08-31','Shipped',NULL,205,NULL),
  (10146,'2003-09-03','2003-09-13','2003-09-06','Shipped',NULL,447,NULL),
  (10147,'2003-09-05','2003-09-12','2003-09-09','Shipped',NULL,379,NULL),
  (10148,'2003-09-11','2003-09-21','2003-09-15','Shipped','They want to reevaluate their terms agreement with Finance.',276,NULL),
  (10149,'2003-09-12','2003-09-18','2003-09-17','Shipped',NULL,487,NULL),
  (10150,'2003-09-19','2003-09-27','2003-09-21','Shipped','They want to reevaluate their terms agreement with Finance.',148,NULL),
  (10151,'2003-09-21','2003-09-30','2003-09-24','Shipped',NULL,311,NULL),
  (10152,'2003-09-25','2003-10-03','2003-10-01','Shipped',NULL,333,NULL),
  (10153,'2003-09-28','2003-10-05','2003-10-03','Shipped',NULL,141,NULL),
  (10154,'2003-10-02','2003-10-12','2003-10-08','Shipped',NULL,219,NULL),
  (10155,'2003-10-06','2003-10-13','2003-10-07','Shipped',NULL,186,NULL),
  (10156,'2003-10-08','2003-10-17','2003-10-11','Shipped',NULL,141,NULL),
  (10157,'2003-10-09','2003-10-15','2003-10-14','Shipped',NULL,473,NULL),
  (10158,'2003-10-10','2003-10-18','2003-10-15','Shipped',NULL,121,NULL),
  (10159,'2003-10-10','2003-10-19','2003-10-16','Shipped',NULL,321,NULL),
  (10160,'2003-10-11','2003-10-17','2003-10-17','Shipped',NULL,347,NULL),
  (10161,'2003-10-17','2003-10-25','2003-10-20','Shipped',NULL,227,NULL),
  (10162,'2003-10-18','2003-10-26','2003-10-19','Shipped',NULL,321,NULL),
  (10163,'2003-10-20','2003-10-27','2003-10-24','Shipped',NULL,424,NULL),
  (10164,'2003-10-21','2003-10-30','2003-10-23','Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesn\'t like the colors and precision of the models.',452,NULL),
  (10165,'2003-10-22','2003-10-31','2003-12-26','Shipped','This order was on hold because customers\'s credit limit had been exceeded. Order will ship when payment is received',148,NULL),
  (10166,'2003-10-21','2003-10-30','2003-10-27','Shipped',NULL,462,NULL),
  (10167,'2003-10-23','2003-10-30',NULL,'Cancelle','Customer called to cancel. The warehouse was notified in time and the order didn\'t ship. They have a new VP of Sales and are shifting their sales model. Our VP of Sales should contact them.',448,NULL),
  (10168,'2003-10-28','2003-11-03','2003-11-01','Shipped',NULL,161,NULL),
  (10169,'2003-11-04','2003-11-14','2003-11-09','Shipped',NULL,276,NULL),
  (10170,'2003-11-04','2003-11-12','2003-11-07','Shipped',NULL,452,NULL),
  (10171,'2003-11-05','2003-11-13','2003-11-07','Shipped',NULL,233,NULL),
  (10172,'2003-11-05','2003-11-14','2003-11-11','Shipped',NULL,175,NULL),
  (10173,'2003-11-05','2003-11-15','2003-11-09','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',278,NULL),
  (10174,'2003-11-06','2003-11-15','2003-11-10','Shipped',NULL,333,NULL),
  (10175,'2003-11-06','2003-11-14','2003-11-09','Shipped',NULL,324,NULL),
  (10176,'2003-11-06','2003-11-15','2003-11-12','Shipped',NULL,386,NULL),
  (10177,'2003-11-07','2003-11-17','2003-11-12','Shipped',NULL,344,NULL),
  (10178,'2003-11-08','2003-11-16','2003-11-10','Shipped','Custom shipping instructions sent to warehouse',242,NULL),
  (10179,'2003-11-11','2003-11-17','2003-11-13','Cancelle','Customer cancelled due to urgent budgeting issues. Must be cautious when dealing with them in the future. Since order shipped already we must discuss who would cover the shipping charges.',496,NULL),
  (10180,'2003-11-11','2003-11-19','2003-11-14','Shipped',NULL,171,NULL),
  (10181,'2003-11-12','2003-11-19','2003-11-15','Shipped',NULL,167,NULL),
  (10182,'2003-11-12','2003-11-21','2003-11-18','Shipped',NULL,124,NULL),
  (10183,'2003-11-13','2003-11-22','2003-11-15','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',339,NULL),
  (10184,'2003-11-14','2003-11-22','2003-11-20','Shipped',NULL,484,NULL),
  (10185,'2003-11-14','2003-11-21','2003-11-20','Shipped',NULL,320,NULL),
  (10186,'2003-11-14','2003-11-20','2003-11-18','Shipped','They want to reevaluate their terms agreement with the VP of Sales',489,NULL),
  (10187,'2003-11-15','2003-11-24','2003-11-16','Shipped',NULL,211,NULL),
  (10188,'2003-11-18','2003-11-26','2003-11-24','Shipped',NULL,167,NULL),
  (10189,'2003-11-18','2003-11-25','2003-11-24','Shipped','They want to reevaluate their terms agreement with Finance.',205,NULL),
  (10190,'2003-11-19','2003-11-29','2003-11-20','Shipped',NULL,141,NULL),
  (10191,'2003-11-20','2003-11-30','2003-11-24','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',259,NULL),
  (10192,'2003-11-20','2003-11-29','2003-11-25','Shipped',NULL,363,NULL),
  (10193,'2003-11-21','2003-11-28','2003-11-27','Shipped',NULL,471,NULL),
  (10194,'2003-11-25','2003-12-02','2003-11-26','Shipped',NULL,146,NULL),
  (10195,'2003-11-25','2003-12-01','2003-11-28','Shipped',NULL,319,NULL),
  (10196,'2003-11-26','2003-12-03','2003-12-01','Shipped',NULL,455,NULL),
  (10197,'2003-11-26','2003-12-02','2003-12-01','Shipped','Customer inquired about remote controlled models and gold models.',216,NULL),
  (10198,'2003-11-27','2003-12-06','2003-12-03','Shipped',NULL,385,NULL),
  (10199,'2003-12-01','2003-12-10','2003-12-06','Shipped',NULL,475,NULL),
  (10200,'2003-12-01','2003-12-09','2003-12-06','Shipped',NULL,211,NULL),
  (10201,'2003-12-01','2003-12-11','2003-12-02','Shipped',NULL,129,NULL),
  (10202,'2003-12-02','2003-12-09','2003-12-06','Shipped',NULL,357,NULL),
  (10203,'2003-12-02','2003-12-11','2003-12-07','Shipped',NULL,141,NULL),
  (10204,'2003-12-02','2003-12-10','2003-12-04','Shipped',NULL,151,NULL),
  (10205,'2003-12-03','2003-12-09','2003-12-07','Shipped',' I need all the information I can get on our competitors.',141,NULL),
  (10206,'2003-12-05','2003-12-13','2003-12-08','Shipped','Can we renegotiate this one?',202,NULL),
  (10207,'2003-12-09','2003-12-17','2003-12-11','Shipped','Check on availability.',495,NULL),
  (10208,'2004-01-02','2004-01-11','2004-01-04','Shipped',NULL,146,NULL),
  (10209,'2004-01-09','2004-01-15','2004-01-12','Shipped',NULL,347,NULL),
  (10210,'2004-01-12','2004-01-22','2004-01-20','Shipped',NULL,177,NULL),
  (10211,'2004-01-15','2004-01-25','2004-01-18','Shipped',NULL,406,NULL),
  (10212,'2004-01-16','2004-01-24','2004-01-18','Shipped',NULL,141,NULL),
  (10213,'2004-01-22','2004-01-28','2004-01-27','Shipped','Difficult to negotiate with customer. We need more marketing materials',489,NULL),
  (10214,'2004-01-26','2004-02-04','2004-01-29','Shipped',NULL,458,NULL),
  (10215,'2004-01-29','2004-02-08','2004-02-01','Shipped','Customer requested that FedEx Ground is used for this shipping',475,NULL),
  (10216,'2004-02-02','2004-02-10','2004-02-04','Shipped',NULL,256,NULL),
  (10217,'2004-02-04','2004-02-14','2004-02-06','Shipped',NULL,166,NULL),
  (10218,'2004-02-09','2004-02-16','2004-02-11','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',473,NULL),
  (10219,'2004-02-10','2004-02-17','2004-02-12','Shipped',NULL,487,NULL),
  (10220,'2004-02-12','2004-02-19','2004-02-16','Shipped',NULL,189,NULL),
  (10221,'2004-02-18','2004-02-26','2004-02-19','Shipped',NULL,314,NULL),
  (10222,'2004-02-19','2004-02-27','2004-02-20','Shipped',NULL,239,NULL),
  (10223,'2004-02-20','2004-02-29','2004-02-24','Shipped',NULL,114,NULL),
  (10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',171,NULL),
  (10225,'2004-02-22','2004-03-01','2004-02-24','Shipped',NULL,298,NULL),
  (10226,'2004-02-26','2004-03-06','2004-03-02','Shipped',NULL,239,NULL),
  (10227,'2004-03-02','2004-03-12','2004-03-08','Shipped',NULL,146,NULL),
  (10228,'2004-03-10','2004-03-18','2004-03-13','Shipped',NULL,173,NULL),
  (10229,'2004-03-11','2004-03-20','2004-03-12','Shipped',NULL,124,NULL),
  (10230,'2004-03-15','2004-03-24','2004-03-20','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',128,NULL),
  (10231,'2004-03-19','2004-03-26','2004-03-25','Shipped',NULL,344,NULL),
  (10232,'2004-03-20','2004-03-30','2004-03-25','Shipped',NULL,240,NULL),
  (10233,'2004-03-29','2004-04-04','2004-04-02','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',328,NULL),
  (10234,'2004-03-30','2004-04-05','2004-04-02','Shipped',NULL,412,NULL),
  (10235,'2004-04-02','2004-04-12','2004-04-06','Shipped',NULL,260,NULL),
  (10236,'2004-04-03','2004-04-11','2004-04-08','Shipped',NULL,486,NULL),
  (10237,'2004-04-05','2004-04-12','2004-04-10','Shipped',NULL,181,NULL),
  (10238,'2004-04-09','2004-04-16','2004-04-10','Shipped',NULL,145,NULL),
  (10239,'2004-04-12','2004-04-21','2004-04-17','Shipped',NULL,311,NULL),
  (10240,'2004-04-13','2004-04-20','2004-04-20','Shipped',NULL,177,NULL),
  (10241,'2004-04-13','2004-04-20','2004-04-19','Shipped',NULL,209,NULL),
  (10242,'2004-04-20','2004-04-28','2004-04-25','Shipped','Customer is interested in buying more Ferrari models',456,NULL),
  (10243,'2004-04-26','2004-05-03','2004-04-28','Shipped',NULL,495,NULL),
  (10244,'2004-04-29','2004-05-09','2004-05-04','Shipped',NULL,141,NULL),
  (10245,'2004-05-04','2004-05-12','2004-05-09','Shipped',NULL,455,NULL),
  (10246,'2004-05-05','2004-05-13','2004-05-06','Shipped',NULL,141,NULL),
  (10247,'2004-05-05','2004-05-11','2004-05-08','Shipped',NULL,334,NULL),
  (10248,'2004-05-07','2004-05-14',NULL,'Cancelle','Order was mistakenly placed. The warehouse noticed the lack of documentation.',131,NULL),
  (10249,'2004-05-08','2004-05-17','2004-05-11','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',173,NULL),
  (10250,'2004-05-11','2004-05-19','2004-05-15','Shipped',NULL,450,NULL),
  (10251,'2004-05-18','2004-05-24','2004-05-24','Shipped',NULL,328,NULL),
  (10252,'2004-05-26','2004-06-04','2004-05-29','Shipped',NULL,406,NULL),
  (10253,'2004-06-01','2004-06-09','2004-06-02','Cancelle','Customer disputed the order and we agreed to cancel it. We must be more cautions with this customer going forward, since they are very hard to please. We must cover the shipping fees.',201,NULL),
  (10254,'2004-06-03','2004-06-13','2004-06-04','Shipped','Customer requested that DHL is used for this shipping',323,NULL),
  (10255,'2004-06-04','2004-06-12','2004-06-09','Shipped',NULL,209,NULL),
  (10256,'2004-06-08','2004-06-16','2004-06-10','Shipped',NULL,145,NULL),
  (10257,'2004-06-14','2004-06-24','2004-06-15','Shipped',NULL,450,NULL),
  (10258,'2004-06-15','2004-06-25','2004-06-23','Shipped',NULL,398,NULL),
  (10259,'2004-06-15','2004-06-22','2004-06-17','Shipped',NULL,166,NULL),
  (10260,'2004-06-16','2004-06-22',NULL,'Cancelle','Customer heard complaints from their customers and called to cancel this order. Will notify the Sales Manager.',357,NULL),
  (10261,'2004-06-17','2004-06-25','2004-06-22','Shipped',NULL,233,NULL),
  (10262,'2004-06-24','2004-07-01',NULL,'Cancelle','This customer found a better offer from one of our competitors. Will call back to renegotiate.',141,NULL),
  (10263,'2004-06-28','2004-07-04','2004-07-02','Shipped',NULL,175,NULL),
  (10264,'2004-06-30','2004-07-06','2004-07-01','Shipped','Customer will send a truck to our local warehouse on 7/1/2004',362,NULL),
  (10265,'2004-07-02','2004-07-09','2004-07-07','Shipped',NULL,471,NULL),
  (10266,'2004-07-06','2004-07-14','2004-07-10','Shipped',NULL,386,NULL),
  (10267,'2004-07-07','2004-07-17','2004-07-09','Shipped',NULL,151,NULL),
  (10268,'2004-07-12','2004-07-18','2004-07-14','Shipped',NULL,412,NULL),
  (10269,'2004-07-16','2004-07-22','2004-07-18','Shipped',NULL,382,NULL),
  (10270,'2004-07-19','2004-07-27','2004-07-24','Shipped','Can we renegotiate this one?',282,NULL),
  (10271,'2004-07-20','2004-07-29','2004-07-23','Shipped',NULL,124,NULL),
  (10272,'2004-07-20','2004-07-26','2004-07-22','Shipped',NULL,157,NULL),
  (10273,'2004-07-21','2004-07-28','2004-07-22','Shipped',NULL,314,NULL),
  (10274,'2004-07-21','2004-07-29','2004-07-22','Shipped',NULL,379,NULL),
  (10275,'2004-07-23','2004-08-02','2004-07-29','Shipped',NULL,119,NULL),
  (10276,'2004-08-02','2004-08-11','2004-08-08','Shipped',NULL,204,NULL),
  (10277,'2004-08-04','2004-08-12','2004-08-05','Shipped',NULL,148,NULL),
  (10278,'2004-08-06','2004-08-16','2004-08-09','Shipped',NULL,112,NULL),
  (10279,'2004-08-09','2004-08-19','2004-08-15','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',141,NULL),
  (10280,'2004-08-17','2004-08-27','2004-08-19','Shipped',NULL,249,NULL),
  (10281,'2004-08-19','2004-08-28','2004-08-23','Shipped',NULL,157,NULL),
  (10282,'2004-08-20','2004-08-26','2004-08-22','Shipped',NULL,124,NULL),
  (10283,'2004-08-20','2004-08-30','2004-08-23','Shipped',NULL,260,NULL),
  (10284,'2004-08-21','2004-08-29','2004-08-26','Shipped','Custom shipping instructions sent to warehouse',299,NULL),
  (10285,'2004-08-27','2004-09-04','2004-08-31','Shipped',NULL,286,NULL),
  (10286,'2004-08-28','2004-09-06','2004-09-01','Shipped',NULL,172,NULL),
  (10287,'2004-08-30','2004-09-06','2004-09-01','Shipped',NULL,298,NULL),
  (10288,'2004-09-01','2004-09-11','2004-09-05','Shipped',NULL,166,NULL),
  (10289,'2004-09-03','2004-09-13','2004-09-04','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',167,NULL),
  (10290,'2004-09-07','2004-09-15','2004-09-13','Shipped',NULL,198,NULL),
  (10291,'2004-09-08','2004-09-17','2004-09-14','Shipped',NULL,448,NULL),
  (10292,'2004-09-08','2004-09-18','2004-09-11','Shipped','They want to reevaluate their terms agreement with Finance.',131,NULL),
  (10293,'2004-09-09','2004-09-18','2004-09-14','Shipped',NULL,249,NULL),
  (10294,'2004-09-10','2004-09-17','2004-09-14','Shipped',NULL,204,NULL),
  (10295,'2004-09-10','2004-09-17','2004-09-14','Shipped','They want to reevaluate their terms agreement with Finance.',362,NULL),
  (10296,'2004-09-15','2004-09-22','2004-09-16','Shipped',NULL,415,NULL),
  (10297,'2004-09-16','2004-09-22','2004-09-21','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',189,NULL),
  (10298,'2004-09-27','2004-10-05','2004-10-01','Shipped',NULL,103,NULL),
  (10299,'2004-09-30','2004-10-10','2004-10-01','Shipped',NULL,186,NULL),
  (10300,'2003-10-04','2003-10-13','2003-10-09','Shipped',NULL,128,NULL),
  (10301,'2003-10-05','2003-10-15','2003-10-08','Shipped',NULL,299,NULL),
  (10302,'2003-10-06','2003-10-16','2003-10-07','Shipped',NULL,201,NULL),
  (10303,'2004-10-06','2004-10-14','2004-10-09','Shipped','Customer inquired about remote controlled models and gold models.',484,NULL),
  (10304,'2004-10-11','2004-10-20','2004-10-17','Shipped',NULL,256,NULL),
  (10305,'2004-10-13','2004-10-22','2004-10-15','Shipped','Check on availability.',286,NULL),
  (10306,'2004-10-14','2004-10-21','2004-10-17','Shipped',NULL,187,NULL),
  (10307,'2004-10-14','2004-10-23','2004-10-20','Shipped',NULL,339,NULL),
  (10308,'2004-10-15','2004-10-24','2004-10-20','Shipped','Customer requested that FedEx Ground is used for this shipping',319,NULL),
  (10309,'2004-10-15','2004-10-24','2004-10-18','Shipped',NULL,121,NULL),
  (10310,'2004-10-16','2004-10-24','2004-10-18','Shipped',NULL,259,NULL),
  (10311,'2004-10-16','2004-10-23','2004-10-20','Shipped','Difficult to negotiate with customer. We need more marketing materials',141,NULL),
  (10312,'2004-10-21','2004-10-27','2004-10-23','Shipped',NULL,124,NULL),
  (10313,'2004-10-22','2004-10-28','2004-10-25','Shipped','Customer requested that FedEx Ground is used for this shipping',202,NULL),
  (10314,'2004-10-22','2004-11-01','2004-10-23','Shipped',NULL,227,NULL),
  (10315,'2004-10-29','2004-11-08','2004-10-30','Shipped',NULL,119,NULL),
  (10316,'2004-11-01','2004-11-09','2004-11-07','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shippment',240,NULL),
  (10317,'2004-11-02','2004-11-12','2004-11-08','Shipped',NULL,161,NULL),
  (10318,'2004-11-02','2004-11-09','2004-11-07','Shipped',NULL,157,NULL),
  (10319,'2004-11-03','2004-11-11','2004-11-06','Shipped','Customer requested that DHL is used for this shipping',456,NULL),
  (10320,'2004-11-03','2004-11-13','2004-11-07','Shipped',NULL,144,NULL),
  (10321,'2004-11-04','2004-11-12','2004-11-07','Shipped',NULL,462,NULL),
  (10322,'2004-11-04','2004-11-12','2004-11-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',363,NULL),
  (10323,'2004-11-05','2004-11-12','2004-11-09','Shipped',NULL,128,NULL),
  (10324,'2004-11-05','2004-11-11','2004-11-08','Shipped',NULL,181,NULL),
  (10325,'2004-11-05','2004-11-13','2004-11-08','Shipped',NULL,121,NULL),
  (10326,'2004-11-09','2004-11-16','2004-11-10','Shipped',NULL,144,NULL),
  (10327,'2004-11-10','2004-11-19','2004-11-13','Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models don\'t match what was discussed.',145,NULL),
  (10328,'2004-11-12','2004-11-21','2004-11-18','Shipped','Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch',278,NULL),
  (10329,'2004-11-15','2004-11-24','2004-11-16','Shipped',NULL,131,NULL),
  (10330,'2004-11-16','2004-11-25','2004-11-21','Shipped',NULL,385,NULL),
  (10331,'2004-11-17','2004-11-23','2004-11-23','Shipped','Customer requested special shippment. The instructions were passed along to the warehouse',486,NULL),
  (10332,'2004-11-17','2004-11-25','2004-11-18','Shipped',NULL,187,NULL),
  (10333,'2004-11-18','2004-11-27','2004-11-20','Shipped',NULL,129,NULL),
  (10334,'2004-11-19','2004-11-28',NULL,'On Hold','The outstaniding balance for this customer exceeds their credit limit. Order will be shipped when a payment is received.',144,NULL),
  (10335,'2004-11-19','2004-11-29','2004-11-23','Shipped',NULL,124,NULL),
  (10336,'2004-11-20','2004-11-26','2004-11-24','Shipped','Customer requested that DHL is used for this shipping',172,NULL),
  (10337,'2004-11-21','2004-11-30','2004-11-26','Shipped',NULL,424,NULL),
  (10338,'2004-11-22','2004-12-02','2004-11-27','Shipped',NULL,381,NULL),
  (10339,'2004-11-23','2004-11-30','2004-11-30','Shipped',NULL,398,NULL),
  (10340,'2004-11-24','2004-12-01','2004-11-25','Shipped','Customer is interested in buying more Ferrari models',216,NULL),
  (10341,'2004-11-24','2004-12-01','2004-11-29','Shipped','XYZ',382,NULL),
  (10342,'2004-11-24','2004-12-01','2004-11-29','Shipped',NULL,114,NULL),
  (10343,'2004-11-24','2004-12-01','2004-11-26','Shipped',NULL,353,NULL),
  (10344,'2004-11-25','2004-12-02','2004-11-29','Shipped',NULL,350,NULL),
  (10345,'2004-11-25','2004-12-01','2004-11-26','Shipped',NULL,103,NULL),
  (10346,'2004-11-29','2004-12-05','2004-11-30','Shipped',NULL,112,NULL),
  (10347,'2004-11-29','2004-12-07','2004-11-30','Shipped','Can we deliver the new Ford Mustang models by end-of-quarter?',114,NULL),
  (10348,'2004-11-01','2004-11-08','2004-11-05','Shipped',NULL,458,NULL),
  (10349,'2004-12-01','2004-12-07','2004-12-03','Shipped',NULL,151,NULL),
  (10350,'2004-12-02','2004-12-08','2004-12-05','Shipped',NULL,141,NULL),
  (10351,'2004-12-03','2004-12-11','2004-12-07','Shipped',NULL,324,NULL),
  (10352,'2004-12-03','2004-12-12','2004-12-09','Shipped',NULL,198,NULL),
  (10353,'2004-12-04','2004-12-11','2004-12-05','Shipped',NULL,447,NULL),
  (10354,'2004-12-04','2004-12-10','2004-12-05','Shipped',NULL,323,NULL),
  (10355,'2004-12-07','2004-12-14','2004-12-13','Shipped',NULL,141,NULL),
  (10356,'2004-12-09','2004-12-15','2004-12-12','Shipped',NULL,250,NULL),
  (10357,'2004-12-10','2004-12-16','2004-12-14','Shipped',NULL,124,NULL),
  (10358,'2004-12-10','2004-12-16','2004-12-16','Shipped','Customer requested that DHL is used for this shipping',141,NULL),
  (10359,'2004-12-15','2004-12-23','2004-12-18','Shipped',NULL,353,NULL),
  (10360,'2004-12-16','2004-12-22','2004-12-18','Shipped',NULL,496,NULL),
  (10361,'2004-12-17','2004-12-24','2004-12-20','Shipped',NULL,282,NULL),
  (10362,'2005-01-05','2005-01-16','2005-01-10','Shipped',NULL,161,NULL),
  (10363,'2005-01-06','2005-01-12','2005-01-10','Shipped',NULL,334,NULL),
  (10364,'2005-01-06','2005-01-17','2005-01-09','Shipped',NULL,350,NULL),
  (10365,'2005-01-07','2005-01-18','2005-01-11','Shipped',NULL,320,NULL),
  (10366,'2005-01-10','2005-01-19','2005-01-12','Shipped',NULL,381,NULL),
  (10367,'2005-01-12','2005-01-21','2005-01-16','Resolved','This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.',205,'2015-11-10'),
  (10368,'2005-01-19','2005-01-27','2005-01-24','Shipped','Can we renegotiate this one?',124,NULL),
  (10369,'2005-01-20','2005-01-28','2005-01-24','Shipped',NULL,379,NULL),
  (10370,'2005-01-20','2005-02-01','2005-01-25','Shipped',NULL,276,NULL),
  (10371,'2005-01-23','2005-02-03','2005-01-25','Shipped',NULL,124,NULL),
  (10372,'2005-01-26','2005-02-05','2005-01-28','Shipped',NULL,398,NULL),
  (10373,'2005-01-31','2005-02-08','2005-02-06','Shipped',NULL,311,NULL),
  (10374,'2005-02-02','2005-02-09','2005-02-03','Shipped',NULL,333,NULL),
  (10375,'2005-02-03','2005-02-10','2005-02-06','Shipped',NULL,119,NULL),
  (10376,'2005-02-08','2005-02-18','2005-02-13','Shipped',NULL,219,NULL),
  (10377,'2005-02-09','2005-02-21','2005-02-12','Shipped','Cautious optimism. We have happy customers here, if we can keep them well stocked.  I need all the information I can get on the planned shippments of Porches',186,NULL),
  (10378,'2005-02-10','2005-02-18','2005-02-11','Shipped',NULL,141,NULL),
  (10379,'2005-02-10','2005-02-18','2005-02-11','Shipped',NULL,141,NULL),
  (10380,'2005-02-16','2005-02-24','2005-02-18','Shipped',NULL,141,NULL),
  (10381,'2005-02-17','2005-02-25','2005-02-18','Shipped',NULL,321,NULL),
  (10382,'2005-02-17','2005-02-23','2005-02-18','Shipped','Custom shipping instructions sent to warehouse',124,NULL),
  (10383,'2005-02-22','2005-03-02','2005-02-25','Shipped',NULL,141,NULL),
  (10384,'2005-02-23','2005-03-06','2005-02-27','Shipped',NULL,321,NULL),
  (10385,'2005-02-28','2005-03-09','2005-03-01','Shipped',NULL,124,NULL),
  (10386,'2005-03-01','2005-03-09','2005-03-06','Resolved','Disputed then Resolved on 3/15/2005. Customer doesn\'t like the craftsmaship of the models.',141,NULL),
  (10387,'2005-03-02','2005-03-09','2005-03-06','Shipped','We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.',148,NULL),
  (10388,'2005-03-03','2005-03-11','2005-03-09','Shipped',NULL,462,NULL),
  (10389,'2005-03-03','2005-03-09','2005-03-08','Shipped',NULL,448,NULL),
  (10390,'2005-03-04','2005-03-11','2005-03-07','Shipped','They want to reevaluate their terms agreement with Finance.',124,NULL),
  (10391,'2005-03-09','2005-03-20','2005-03-15','Shipped',NULL,276,NULL),
  (10392,'2005-03-10','2005-03-18','2005-03-12','Shipped',NULL,452,NULL),
  (10393,'2005-03-11','2005-03-22','2005-03-14','Shipped','They want to reevaluate their terms agreement with Finance.',323,NULL),
  (10394,'2005-03-15','2005-03-25','2005-03-19','Shipped',NULL,141,NULL),
  (10395,'2005-03-17','2005-03-24','2005-03-23','Shipped','We must be cautions with this customer. Their VP of Sales resigned. Company may be heading down.',250,NULL),
  (10396,'2005-03-23','2005-04-02','2005-03-28','Shipped',NULL,124,NULL),
  (10397,'2005-03-28','2005-04-09','2005-04-01','Shipped',NULL,242,NULL),
  (10398,'2005-03-30','2005-04-09','2005-03-31','Shipped',NULL,353,NULL),
  (10399,'2005-04-01','2005-04-12','2005-04-03','Shipped',NULL,496,NULL),
  (10400,'2005-04-01','2005-04-11','2005-04-04','Shipped','Customer requested that DHL is used for this shipping',450,NULL),
  (10401,'2005-04-03','2005-04-14',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',328,NULL),
  (10402,'2005-04-07','2005-04-14','2005-04-12','Shipped',NULL,406,NULL),
  (10403,'2005-04-08','2005-04-18','2005-04-11','Shipped',NULL,201,NULL),
  (10404,'2005-04-08','2005-04-14','2005-04-11','Shipped',NULL,323,NULL),
  (10405,'2005-04-14','2005-04-24','2005-04-20','Shipped',NULL,209,NULL),
  (10406,'2005-04-15','2005-04-25','2005-04-21','Disputed','Customer claims container with shipment was damaged during shipping and some items were missing. I am talking to FedEx about this.',145,NULL),
  (10407,'2005-04-22','2005-05-04',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',450,NULL),
  (10408,'2005-04-22','2005-04-29','2005-04-27','Shipped',NULL,398,NULL),
  (10409,'2005-04-23','2005-05-05','2005-04-24','Shipped',NULL,166,NULL),
  (10410,'2005-04-29','2005-05-10','2005-04-30','Shipped',NULL,357,NULL),
  (10411,'2005-05-01','2005-05-08','2005-05-06','Shipped',NULL,233,NULL),
  (10412,'2005-05-03','2005-05-13','2005-05-05','Shipped',NULL,141,NULL),
  (10413,'2005-05-05','2005-05-14','2005-05-09','Shipped','Customer requested that DHL is used for this shipping',175,NULL),
  (10414,'2005-05-06','2005-05-13',NULL,'On Hold','Customer credit limit exceeded. Will ship when a payment is received.',362,NULL),
  (10415,'2005-05-09','2005-05-20','2005-05-12','Disputed','Customer claims the scales of the models don\'t match what was discussed. I keep all the paperwork though to prove otherwise',471,NULL),
  (10416,'2005-05-10','2005-05-16','2005-05-14','Shipped',NULL,386,NULL),
  (10417,'2005-05-13','2005-05-19','2005-05-19','Disputed','Customer doesn\'t like the colors and precision of the models.',141,NULL),
  (10418,'2005-05-16','2005-05-24','2005-05-20','Shipped',NULL,412,NULL),
  (10419,'2005-05-17','2005-05-28','2005-05-19','Shipped',NULL,382,NULL),
  (10420,'2005-05-29','2005-06-07',NULL,'In Proce',NULL,282,NULL),
  (10421,'2005-05-29','2005-06-06',NULL,'In Proce','Custom shipping instructions were sent to warehouse',124,NULL),
  (10422,'2005-05-30','2005-06-11',NULL,'In Proce',NULL,157,NULL),
  (10423,'2005-05-30','2005-06-05',NULL,'In Proce',NULL,314,NULL),
  (10424,'2005-05-31','2005-06-08',NULL,'In Proce',NULL,141,NULL),
  (10425,'2005-05-31','2005-06-07',NULL,'In Proce',NULL,119,NULL),
  (10426,'2010-08-20','2010-08-20',NULL,'Open','foo',123456,NULL),
  (10753,'2015-11-10','2015-11-10','2015-11-10','Cancelle','test',141,NULL),
  (10754,'2015-11-10','2015-11-10','2015-11-10','CANCELLE','ET',382,NULL),
  (10755,'2015-11-10','2015-11-10','2015-11-10','Cancelle','testasfsfsadfs',282,NULL),
  (10756,'2016-01-14','2016-01-14','2016-01-14',NULL,'asdfsad',1234,NULL),
  (10766,'2015-01-02','2015-01-02',NULL,'BOBO',NULL,0,NULL),
  (10767,'2003-01-23','2003-01-31',NULL,'Shipped','Check on availability.111\n',128,NULL),
  (10768,'2003-02-17','2003-02-28',NULL,'Shipped','<p>Foobar <b>using</b> XML as <i>datasource</i></p>',278,NULL),
  (10769,'2003-03-03','2003-03-08',NULL,'Shipped','test',385,NULL),
  (10770,'2003-02-24','2003-03-03','2003-02-26','Shipped','Difficult to negotiate with customer. We need more marketing materials',131,NULL),
  (10771,'2003-01-23','2003-01-31',NULL,'Shipped','Check on availability.111\n',128,NULL),
  (10772,'2003-01-23','2003-01-31',NULL,'Shipped','Check on availability.111\n',128,NULL),
  (10773,'2003-01-24','1918-11-23','1946-05-15','Shipped','<p style=\"text-align: center;\">xzzzz</p>',181,NULL),
  (10774,'2003-01-23','2003-01-31',NULL,'Shipped','Check on availability.111\n',128,NULL),
  (10775,'2003-01-06','2003-11-13','2003-01-10','Shipped','foo',363,NULL),
  (10776,'2003-01-06','2003-11-13','2003-01-10','Shipped','foo',363,NULL),
  (10777,'2003-01-06','2003-11-13','2003-01-10','Shipped','foo',363,NULL),
  (10778,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',141,NULL),
  (10779,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',141,NULL),
  (10780,'2003-01-24','1918-11-23','1946-05-15','Shipped','<p style=\"text-align: center;\">xzzzz</p>',181,NULL),
  (10781,'2003-03-03','2003-03-08',NULL,'Shipped','testxxxxzz',385,NULL),
  (10782,'2003-02-17','2003-02-28',NULL,'Shipped','<p>Foobar <b>using</b> XML as <i>datasource</i></p>',278,NULL),
  (10783,'2003-01-25','2003-02-22',NULL,'Shipped','\nsafsdfasdf sadffs sfaffsfzzzzzzzžzzzsfgredgsdxxx\n',1411,NULL),
  (10784,'2003-01-25','2003-02-22',NULL,'Shipped','\nsafsdfasdf sadffs sfaffsfzzzzzzzžzzzsfgredgsdxxx\n',1411,NULL),
  (10785,'2003-03-03','2003-03-08',NULL,'Shipped','test',385,NULL),
  (10786,'2003-01-06','2003-11-13','2003-01-10','Shipped','foo',363,NULL),
  (10787,'2003-01-25','2003-02-22',NULL,'Shipped','\nsafsdfasdf sadffs sfaffsfzzzzzzzžzzzsfgredgsdxxx\n',1411,NULL),
  (10788,'2003-02-11','2003-02-21','2013-02-26','Shipped','<p>test123</p>',124,NULL),
  (10789,'2003-01-24','1918-11-23','1946-05-15','Shipped',NULL,181,NULL),
  (10790,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',141,NULL),
  (10791,'2003-02-17','2003-02-28',NULL,'Shipped','<p>Foobar <b>using</b> XML as <i>datasource</i></p>',278,NULL),
  (10792,'2016-07-07','2016-07-02','2016-07-09','Open','asdfsa',123,'2016-07-14'),
  (10793,'2016-10-12','2016-10-15','2016-10-31','OnHold','test123d \n\nasdfsdf',111,NULL),
  (10794,'2016-10-10','2016-10-06','2016-10-29','Shippedz','test',111,NULL),
  (10795,'2016-10-12','2016-07-28','2016-10-27','Shipped',NULL,123,NULL),
  (10796,'2016-10-10','2016-10-10','2016-10-10','Shipped',NULL,123,NULL),
  (10797,'2016-10-10','2016-10-10','2016-10-10','Shipped',NULL,123,NULL),
  (10798,'2016-10-10','2016-10-10','2016-10-10','Cancelle',NULL,123,NULL),
  (10799,'2016-10-10','2016-10-10','2016-10-10','Status2',NULL,1121,NULL),
  (10800,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10801,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10802,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10803,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10804,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10805,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10806,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10807,'2007-02-23','2016-07-29','2015-11-18','Shipped','<p>fasdfasdfa asdfa</p>',1411,NULL),
  (10808,'2003-03-25','2003-03-31','2003-03-30','Shipped','test sdfasfsdfasdfs safasdfadsfsfas',129,NULL),
  (10809,'2003-03-25','2003-03-31','2003-03-30','Shipped','test sdfasfsdfasdfs safasdfadsfsfas',129,NULL),
  (10810,'2003-03-10','2003-03-19','2003-03-11','Shipped','Customer requested that FedEx Ground is used for this shipping',486,NULL),
  (10811,'2003-03-03','2003-03-08',NULL,'Shipped','test',385,NULL),
  (10812,'2003-03-25','2003-03-31','2003-03-30','Shipped','test sdfasfsdfasdfs safasdfadsfsfas',129,NULL),
  (10813,'2003-03-26','2003-04-02','2003-03-27','Shipped','XYZ23333',124,NULL);
...
VALUES
  (103,'OM31493','2004-12-18 00:00:00',1676.14),
  ...
  (172,'AD83209111','2004-09-09 00:00:00',1960.8),
...
CREATE TABLE `productlines` (
  `productLine` varchar(50) NOT NULL DEFAULT 'ZZZ',
...
VALUES
  ('Vintage Cars','Our Vintage Car models realistically portray automobiles produced from the early 1900s through the 1940s. Materials used include Bakelite, diecast, plastic and wood. Most of the replicas are in the 1:18 and 1:24 scale sizes, which provide the optimum in detail and accuracy. Prices range from $30.00 up to $180.00 for some special limited edition replicas. All models include a certificate of authenticity from their manufacturers and come fully assembled and ready for display in the home or office.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F76696E746167655F6361722E6A7067'),
  ('Ships','The perfect holiday or anniversary gift for executives, clients, friends, and family. These handcrafted model ships are unique, stunning works of art that will be treasured for generations! They come fully assembled and ready for display in the home or office. We guarantee the highest quality, and best value.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F736869702E676966'),
  ('Trains','Model trains are a rewarding hobby for enthusiasts of all ages. Whether you\'re looking for collectible wooden trains, electric streetcars or locomotives, you\'ll find a number of great choices for any budget within this category. The interactive aspect of trains makes toy trains perfect for young children. The wooden train sets are ideal for children under the age of 5.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F747261696E2E6A7067'),
  ('Planes','Unique, diecast airplane and helicopter replicas suitable for collections, as well as home, office or classroom decorations. Models contain stunning details such as official logos and insignias, rotating jet engines and propellers, retractable wheels, and so on. Most come fully assembled and with a certificate of authenticity from their manufacturers.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F616972706C616E652E6A7067'),
  ('Motorcycles','Our motorcycles are state of the art replicas of classic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully assembled and ready for display in the home or office. Most include a certificate of authenticity.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F6D6F746F726379636C652E6A7067'),
  ('Classic Cars','Attention car enthusiasts: Make your wildest car ownership dreams come true. Whether you are looking for classic muscle cars, dream sports cars or movie-inspired miniatures, you will find great choices in this category. These replicas feature superb attention to detail and craftsmanship and offer features such as working steering system, opening forward compartment, opening rear trunk with removable spare wheel, 4-wheel independent spring suspension, and so on. The models range in size from 1:10 to 1:24 scale and include numerous limited edition and several out-of-production vehicles. All models include a certificate of authenticity from their manufacturers and come fully assembled and ready for display in the home or office.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F636C61737369635F6361722E6A7067'),
  ('Trucks and Buses','The Truck and Bus models are realistic replicas of buses and specialized trucks produced from the early 1920s to present. The models range in size from 1:12 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. Materials used include tin, diecast and plastic. All models include a certificate of authenticity from their manufacturers and are a perfect ornament for the home and office.',NULL,X'70687047726964782F53616D706C65496D616765732F70686F746F732F747275636B2E6A7067');

/*!40000 ALTER TABLE `productlines` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table productparts
# ------------------------------------------------------------

DROP TABLE IF EXISTS `productparts`;

CREATE TABLE `productparts` (
  `partNo` int(15) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `productparts` (`partNo`, `partName`, `productCode`)
VALUES
  (1,'Knock sensor','S10_1678'),
  (2,'Battery switch','S10_1678'),
  (3,'Switch cover','S10_1678'),
  (4,'Light sensor','S10_1949'),
  (5,'Door switch','S10_1949'),
  (6,'Performance monitor','S10_1949'),
  (7,'Manifold absolute pressure sensor','S10_2016'),
  (8,'Door switch','S10_2016'),
  (9,'Speed controller','S10_2016'),
  (10,'Starter motor','S10_4698'),
  (11,'Ignition switch','S10_4698'),
  (12,'Relay connector','S10_4698'),
  (13,'Oxygen sensorzz','S10_4757'),
  (14,'Shift improver','S10_4962'),
  (15,'Remote LOCK','S12_1099'),
  (16,'Starter drive','S12_1108'),
  (17,'POWER window switch','S12_1666\r\nS12_2823\r\n'),
  (18,'Steering COLUMN switch','S12_2823'),
  (19,'Ground strap','S12_3148'),
  (20,'Oxygen sensor','S12_3380'),
  (21,'Performance chip','S12_3891'),
  (22,'Pressure sensor','S12_3990'),
  (23,'Armrest','S12_4473'),
  (24,'Bench seat','S12_4675'),
  (25,'Seat cover','S18_1097'),
  (26,'Bucket seat','S18_1129'),
  (27,'Seat track','S18_1342'),
  (28,'Seat bracket','S18_1367'),
  (29,'Seat belt','S18_1589'),
  (30,'Headrest','S18_1662'),
  (31,'Fastener','S18_1749'),
  (32,'Brake cooling duct','S18_1889'),
  (33,'Brake disc','S18_1984'),
  (34,'Camshaft pushrod','S18_2238'),
  (35,'Brake line','S18_2248'),
  (36,'Camshaft locking plate','S18_2319'),
  (37,'Camshaft follower','S18_2325');
...
INSERT INTO `products` (`productCode`, `productName`, `productUrl`, `productLine`, `productScale`, `productVendor`, `productDescription`, `quantityInStock`, `buyPrice`, `MSRP`, `Image`, `supplierZip`)
VALUES
  ('S10_1678','1969 Harley Davidson Ultimate Chopper','http://harleydavidson.com','Motocycle','1:10','Min Lin Diecastzzzz','This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.',79,48.81,95.7,'SampleImages/motorcycle.jpg','91801-3328'),
  ('S10_3000','1952 Alpine Renault 1300','http://alpinerenault.com','Classic Cars','1:100','Classic Metal Creations','Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',7305,98.58,214.3,'SampleImages/classic_car.png','91801-3328'),
  ...
  ('S10_4757','1972 Alfa Romeo GTA','http://abcdef.com','Classic Cars','1:10','Motor City Art Classics','Features include: Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',3252,85.68,136,'SampleImages/classic_car.png','91801-1949'),
  ('S10_4962','1962 LanciaA Delta 16V','','Classic Cars','1:10','Second Gear Diecastddd','Features include: Turnable front wheels; steering function; detailed interior; detailed engine; opening hood; opening trunk; opening doors; and detailed chassis.',6791,103.42,147.74,'SampleImages/classic_car.png','91801-1949'),
  ...
  ('S12_1666','1958 Setra Bus','','Trucks and Buses','1:12','Welly Diecast Productions','Model features 30 windows, skylights & glare resistant glass, working steering system, original logos',1579,77.9,136.67,'SampleImages/truck.jpg','91801-1949'),
  ...
  ('S12_3990','1970 Plymouth Hemi Cuda','','Classic Cars','1:12','Studio M Art Models','Very detailed 1970 Plymouth Cuda model in 1:12 scale. The Cuda is generally accepted as one of the fastest original muscle cars from the 1970s. This model is a reproduction of one of the orginal 652 cars built in 1970. Red color.',5663,31.92,79.81,'SampleImages/classic_car.png','91801-1949'),
  ...
  ('S18_1097','1940 Ford Pickup Truck','','Trucks and Buses','1:18','Studio M Art Models','This model features soft rubber tires, working steering, rubber mud guards, authentic Ford logos, detailed undercarriage, opening doors and hood,  removable split rear gate, full size spare mounted in bed, detailed interior with opening glove box',2613,588,116.67,'SampleImages/truck.jpg','91801-3328'),
  ...
  ('S18_1342','1937 Lincoln Berline','11','Vintage Cars','1:18','Motor City Art Classics','Features opening engine cover, doors, trunk, and fuel filler cap. Color black',8693,60.62,102.74,'SampleImages/vintage_car.png','91801-3328'),
  ...
  ('S18_1749\'s','1917 Grand Touring Sedan','http://fuckingawesome.com','Vintage Cars','1:18','Welly Diecast Productions','This 1:18 scale replica of the 1917 Grand Touring car has all the features you would expect from museum quality reproductions: all four doors and bi-fold hood opening, detailed engine and instrument panel, chrome-look trim, and tufted upholstery, all topped off with a factory baked-enamel finish.',2724,86.7,170,'SampleImages/vintage_car.png',''),
  ...
  ('S18_2248','1911 Ford Town Car','','Vintage Cars','1:18','Motdor City Art Classics','Features opening hood, opening doors, opening trunk, wide white wall tires, front door arm rests, working steering system.',540,33.3,60.54,'SampleImages/vintage_car.png',''),
  ...
  ('S24_3969','1936 Mercedes Benzzzz 500k Roadster','','Vintage Cars','1:24','Red Start Diecast','This model features grille-mounted chrome horn, lift-up louvered hood, fold-down rumble seat, working steering system and rubber wheels. Color black.',2081,21.75,41.03,'SampleImages/vintage_car.png',''),
  ('S24_4048','1992 Porsche Cayenne Turbo Silver','','Classic Cars','1:24','Exoto Designs','This replica features opening doors, superb detail and craftsmanship, working steering system, opening forward compartment, opening rear trunk with removable spare, 4 wheel independent spring suspension as well as factory baked enamel finish.SSSSS',6582,69.78,118.28,'SampleImages/classic_car.png',''),
  ...
  ('11','1952 Alpine Renault 1300','test','test','test','tes','testzzzbbbb',1,100,199,'','91111'),
  ('S10_111','2000 Benz','N/Azzzz','Motocycle','1:50','MINIME','N/A',32767,20000,40000,'','91801');
...
CREATE TABLE `shippers` (
  ...
  `fileToUpload` varchar(200) NOT NULL,
...
INSERT INTO `shippers` (`ShipperID`, `CompanyName`, `Phone`, `fileToUpload`)
VALUES
  (1,'Speedy Esd','(503) 555-983123','php logo.jpg'),
  (2,'United Package','34324dfdf','php-logo.png'),
  (3,'Federal Shippingss','(503) 555-99313','phpmysql.png'),
  (13,'safs','safsdaf',''),
  (14,'123432asfsadf','23432','download.png');

/*!40000 ALTER TABLE `shippers` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table suppliermaster
# ------------------------------------------------------------
...
CREATE TABLE `suppliermaster` (
  ...
  `Brank` varchar(20) DEFAULT NULL,
  `IFSC` varchar(15) DEFAULT NULL,
  `CP1` varchar(50) DEFAULT NULL,
  `CNo1` varchar(11) DEFAULT NULL,
  `CEmail1` varchar(11) DEFAULT NULL,
  `CP2` varchar(11) DEFAULT NULL,
  `CNo2` varchar(15) DEFAULT NULL,
  `CEMail2` varchar(50) DEFAULT NULL,
  `CSCode` varchar(15) DEFAULT NULL,
...
INSERT INTO `suppliermaster` (`SCode`, `Add1`, `Add2`, `Add3`, `City`, `State`, `postCode`, `Org`, `EMail`, `BankName`, `VAT`, `CST`, `PAN`, `ST`, `Brank`, `IFSC`, `CP1`, `CNo1`, `CEmail1`, `CP2`, `CNo2`, `CEMail2`, `CSCode`, `Sname`)
VALUES
  ('Vend1','153','SIDCO','INDUSTRIAL ESTATE','1','1',NULL,'PARTNERSHIP','trial@trial.com','ABC','VAT123','CST123','PAN123','ST123','CBA','UTIABCCBA','t1','123456',NULL,'t2','12345678','t1@trial.cm','S001','Trial1'),
  ('Vend2','153','SIDCO','INDUSTRIAL ESTATE','1','1',NULL,'PARTNERSHIP','trial@trial.com','ABC','VAT123','CST123','PAN123','ST123','CBA','UTIABCCBA','t1','123456',NULL,'t2','12345678','t1@trial.cm','S002','Trial1');

/*!40000 ALTER TABLE `suppliermaster` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table supplierproductlines
# ------------------------------------------------------------

DROP TABLE IF EXISTS `supplierproductlines`;

CREATE TABLE `supplierproductlines` (
  `productLineNo` int(11) NOT NULL AUTO_INCREMENT,
  `productLine` varchar(50) DEFAULT NULL,
  `supplierCode` int(15) DEFAULT NULL,
  `supplierName` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`productLineNo`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

LOCK TABLES `supplierproductlines` WRITE;
/*!40000 ALTER TABLE `supplierproductlines` DISABLE KEYS */;

INSERT INTO `supplierproductlines` (`productLineNo`, `productLine`, `supplierCode`, `supplierName`)
VALUES
  (1,'Classic Cars',1,'MIN Lin Diecast'),
  (2,'Vintage Cars',1,'MIN Lin Diecast'),
  (3,'Planes',1,'MIN Lin Diecast'),
  (4,'Ships',1,'MIN Lin Diecast'),
  (5,'Motorcycles',1,'MIN Lin Diecast'),
  (6,'Vintage Cars',2,'Classic Metal Creations'),
  (7,'Trucks and Buses',2,'Classic Metal Creations'),
  (8,'Trains',2,'Classic Metal Creations'),
  (9,'Planes',2,'Classic Metal Creations'),
  (10,'Classic Cars',2,'Classic Metal Creations'),
  (12,'Motorcycles',3,'Highway 66 Mini Classics'),
  (13,'Planes',3,'Highway 66 Mini Classics'),
  (14,'Trucks and Buses',3,'Highway 66 Mini Classics'),
  (15,'Classic Cars',3,'Highway 66 Mini Classics'),
  (16,'Ships',4,'Red START Diecast'),
  (17,'Motorcycles',4,'Red START Diecast'),
  (18,'Planes',4,'Red START Diecast'),
  (19,'Vintage Cars',4,'Red START Diecast'),
  (20,'Classic Cars',4,'Red START Diecast'),
  (21,'Trucks and Buses',4,'Red START Diecast'),
  (22,'Vintage Cars',5,'Motor City Art Classics'),
  (23,'Planes',5,'Motor City Art Classics'),
  (24,'Trucks and Buses',5,'Motor City Art Classics'),
  (25,'Classic Cars',5,'Motor City Art Classics'),
  (26,'Planes',6,'SECOND Gear Diecast'),
  (27,'Motorcycles',6,'SECOND Gear Diecast'),
  (28,'Vintage Cars',6,'SECOND Gear Diecast'),
  (29,'Classic Cars',6,'SECOND Gear Diecast'),
  (30,'Ships',7,'Autoart Studio Design'),
  (31,'Classic Cars',7,'Autoart Studio Design'),
  (32,'Motorcycles',7,'Autoart Studio Design'),
  (33,'Trucks and Buses',7,'Autoart Studio Design'),
  (34,'Vintage Cars',7,'Autoart Studio Design'),
  (35,'Planes',7,'Autoart Studio Design'),
  (36,'Motorcycles',8,'Welly Diecast Productions'),
  (37,'Trucks and Buses',8,'Welly Diecast Productions'),
  (38,'Vintage Cars',8,'Welly Diecast Productions'),
  (39,'Ships',8,'Welly Diecast Productions'),
  (40,'Classic Cars',8,'Welly Diecast Productions'),
  (41,'Classic Cars',9,'Unimax Art Galleries'),
  (42,'Trucks and Buses',9,'Unimax Art Galleries'),
  (43,'Motorcycles',9,'Unimax Art Galleries'),
  (44,'Planes',9,'Unimax Art Galleries'),
  (45,'Ships',9,'Unimax Art Galleries'),
  (46,'Vintage Cars',9,'Unimax Art Galleries'),
  (47,'Classic Cars',10,'Studio M Art Models'),
  (48,'Vintage Cars',10,'Studio M Art Models'),
  (49,'Trucks and Buses',10,'Studio M Art Models'),
  (50,'Ships',10,'Studio M Art Models'),
  (51,'Motorcycles',10,'Studio M Art Models'),
  (52,'Classic Cars',11,'Exoto Designs'),
  (53,'Trucks and Buseszzz',11,'Exoto Designs'),
  (54,'Vintage Cars',11,'Exoto Designs'),
  (55,'Motorcycles',11,'Exoto Designs'),
  (56,'Planes',12,'Gearbox Collectibles'),
  (57,'Motorcycles',12,'Gearbox Collectibles'),
  (58,'Vintage Cars',12,'Gearbox Collectibles'),
  (59,'Trains',12,'Gearbox Collectibles'),
  (60,'Classic Cars',12,'Gearbox Collectibles'),
  (61,'Vintage Cars',13,'Carousel DieCast Legends'),
  (62,'Ships',13,'Carousel DieCast Legends'),
  (63,'Trains',13,'Carousel DieCast Legends'),
  (64,'Classic Cars',13,'Carousel DieCast Legends'),
  (65,'Trucks and Buses',13,'Carousel DieCast Legends');

/*!40000 ALTER TABLE `supplierproductlines` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `suppliers` (
  `supplierCode` int(15) NOT NULL AUTO_INCREMENT,
  `supplierName` varchar(50) DEFAULT NULL,
  `supplierAddress` varchar(1000) DEFAULT NULL,
  `supplierState` varchar(10) DEFAULT NULL,
  `supplierZip` varchar(20) DEFAULT NULL,
  `supplierPhoneNumber` varchar(50) DEFAULT NULL,
...
INSERT INTO `suppliers` (`supplierCode`, `supplierName`, `supplierAddress`, `supplierState`, `supplierZip`, `supplierPhoneNumber`)
VALUES
  (1,'MIN Lin Diecast','1247 W Main St Alhambra','CA','91801-3330','626-289-0000'),
  (2,'Classic Metal Creations','726 F Main St Alhambra','CA','91801-4098','626-289-6161'),
  (3,'Highway 66 Mini Classics','1543W Main St ZYZSSSzzz','CA','91801-1949','3453454353'),
  (4,'Red START Diecast','1200 W Main St Alhambra','CA','91801-3329','626-576-2800'),
  (5,'Motor City Art Classics','1100 W Main St Alhambra','CA','91801-3327','626-308-4500'),
  (6,'SECOND Gear Diecast','2121 W Main St Alhambra','CA','91801-1857','626-289-6301'),
  (7,'Autoart Studio Designzzzz','1125 W Main St Alhambra','CA','91801-3328','<span id=\"gc-number-6\" class=\"gc-cs-link\" title=\"C'),
  (8,'Welly Diecast Productions','400 S Atlantic Blvd Alhambra','CA','91801-3642','626-289-3591'),
  (9,'Unimax Art Galleries','1811 W Main St Alhambra','CA','91801-1829','626-308-4415'),
  (10,'Studio M Art Models','1400 W Main St Alhambra','CA','91801-1952','626-576-1114'),
  (11,'Exoto Designs','3001 W Main St Alhambra','CA','91801-1699','626-570-8444'),
  (12,'Gearbox Collectibles','1800W Main St Alhambra','CA','91801-1828','626-284-9291'),
  (13,'Carousel DieCast Legends','1700 W Main St Alhambra','CA','91801-1826','626-284-8533');
