...
<ul class="list-inline pull-right">
  ...
  Reject
                    ...
                    <li><button type="button" data-toggle="modal"  data-target="#exampleModalLong2"  class="btn btn-success">Publish</button></li>
                </ul>
...
<div class="modal fade" id="exampleModalLong2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLongTitle">Are You Sure You want to Publish ?</h4>
...
xmlhttp.open('GET','http://localhost:8888/codeigniter/index.php/welcome/acceptstatus3?id1=<?php echo $result[0]->id;?>',true);
//alert("Hello2");
xmlhttp.send();
