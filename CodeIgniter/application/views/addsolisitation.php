                                        ...
                                        <div class="row">
                                            <div class="col-sm-5">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" class="form-control" id="sid" style="font-size: 17px; font-weight:bold; color: #4b78c1; " >
                                                </div>
                                            </div>
                                            <div class="col-sm-7">
                                                <div class="form-group">
                                                    <label for="title"><b>Title</b></label>
                                                    <input type="text" class="form-control" id="title" style="font-size: 17px; font-weight: 490; color: #4b78c1; " font-weight:bold; >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="input-append date form_datetime" class="form-control"  style="font-size: 17px; font-weight: 490; color: #4b78c1; " id="finalfilingdatetime">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  style="font-size: 17px; font-weight: 490; color: #4b78c1; " id="title1" placeholder="Solicitation"">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="category" ><b>Category</b></label>
                                                    <input type="text" class="form-control"   style="font-size: 17px; font-weight: 490; color: #4b78c1; " id="title2" placeholder="IT"">
                                                </div>
                                            </div>
                                        </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" href="http://localhost:8888/Admin%20DashBroad/ReviewerDashbroad.html" class="btn btn-primary " onclick="call();" >Yes</a>
      </div>
    </div>
  </div>
</div>
                ...
                <ul class="list-inline pull-right">
                    <li><button type="button" class="btn btn-default prev-step">Previous</button></li>
                    <li><a  href="http://localhost:8888/Admin%20DashBroad/AdminDashbroad.html" type="button" class="btn btn-primary prev-step">Save</a></li>
  ...
  Delete
            ...
            <div class="tab-pane" role="tabpanel" id="complete">
                <h3>Completed</h3>
                <p>Your Solicitation request has been sent to the reviewer</p>



           <ul class="list-inline pull-right">
                    <li><a  href="http://localhost:8888/Admin%20DashBroad/AdminDashbroad.html?id1=" type="button" class="btn btn-default prev-step">Dashboard</a></li>
     <li><a href="http://localhost:8888/codeigniter/index.php/welcome/addsolisitation" type="button" class="btn btn-danger">
  Add New Solication
    </a></li>
                    <li><button type="button"   class="btn btn-success">Solication List</button></li>
                </ul>
...
xmlhttp.open('GET','http://localhost:8888/codeigniter/index.php/welcome/canceldoc',true);
...
xmlhttp.open('GET','http://localhost:8888/codeigniter/index.php/welcome/bgrid',true);
        ...
        $("#snext").click(function()
        {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    alert("Solicitation successfully added");
                },
                error:function(data){
                 //   alert("error happend");
                }
