...
<a  href="http://localhost:8888/codeigniter/index.php/welcome/checkingpage?id='.$post->id.'"   style="background-color:#1898DD; color:white;" class="btn  btn-xs"  ><span style="width: 40px;" class="glyphicon glyphicon-folder-close"></span></a></p>
