...
<div class="container">
    <br/>
    <h3 align="center">Solicitation List</h3>
    <br />
            ...
            <?php if(count($docs)):?>
                <?php foreach($docs as $doc):?>
                    <tr>
                        ...
                        <td><a title ="Click to view the number of bidders bidded for this solicitation" href = "SolicitationSpecific?id='<?php echo $doc->Title;?>'"><?php echo $doc->Title;?></td>
                    </tr>
                <?php endforeach;?>
            <?php else: ?>
...
<div align="middle">
    <a href="evaluationhome" class="btn btn-primary">Evaluation Status</a>
    <br/>
    <br/>
    <br/>
    <br/>
